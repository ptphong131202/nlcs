<?php
// lấy đường dẫn tuyệt đối của tiệp tìn hiện tại đang chứa mã php
...
class customer
{
    ...
    public function insert_binhluan($customer_id,$id) {
        ...
        // nếu bl rổng
        if($binhluan == "") {
            $alert = "<span class='error'>Nội dung bình luận không được rổng!</span>";
            return $alert;
        }
        // ngược lại khong rổng thì
        else{
            // thêm bl vào bảng comment id sp, id người dùng và content bl
    ...
    public function insert_customers($data){
        ...
        // kiểm tra xem có rổng ko
        if($name == ""  ) {
            $alert = "<span class='error'>Tên người dùng không được để trống!</span>";
            return $alert;
        }
        if($address == "" ) {
            $alert = "<span class='error'>Địa chỉ không được để trống!</span>";
            return $alert;
        }
        if($phone == "") {
            $alert = "<span class='error'>Số điện thoại không được để trống!</span>";
            return $alert;
        }
        if($email == "") {
            $alert = "<span class='error'>Email không được để trống!</span>";
            return $alert;
        }
        if($password == "" ) {
